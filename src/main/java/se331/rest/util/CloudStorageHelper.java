...
public class CloudStorageHelper {
    ...
    static {
        ...
        try{
            ...
            storage = StorageOptions.newBuilder().setCredentials(GoogleCredentials.fromStream(serviceAccount)).setProjectId("imageupload-a3258").build().getService();
        }catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    // Convert yteArrayOutputStream into byte[]
        BlobInfo blobInfo =
